...
means=(data['Context']['combined'][0:6])
...
errors=data['Context']['combined_error'][0][0:6]
...
plt.bar(np.arange(5),toplot, label='context_co',yerr=errors_toplot, capsize=2, color =colorbar, alpha=0.8, edgecolor='black')
